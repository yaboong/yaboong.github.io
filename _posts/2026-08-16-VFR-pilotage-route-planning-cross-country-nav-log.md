---
layout: post
title: "Direct Isn't Always Best: VFR Pilotage Route Planning"
date: 2026-08-16
banner_image: aviation-experience.png
categories: [aviation-experience]
tags: [XC, cross-country, navigation-log, route-planning, VFR, pilotage, dead-reckoning]
---
...
{% include image_caption_href.html title="Not-Direct - 4500ft" caption="Not-Direct - 4500ft" imageurl="/posts_image/2026-08-16/route-7B2-KITH-4500-pilotage.png" %}
...
* A feature far from your course line makes drift hard to judge.
Staying within roughly 1-3 NM of the course, on either side, is what lets you reliably tell how far off course you are.
For a rough position check, up to about 5NM can still work.
...
{% include image_caption_href.html title="NOTAMs VOR Unserviceable" caption="NOTAMs VOR Unserviceable" imageurl="/posts_image/2026-08-16/vor-NOTAM-unserviceable.png" %}

**VOR (ALB) Line-of-Sight**
{% include image_caption_href.html title="ALB VOR Unusable" caption="ALB VOR Unusable" imageurl="/posts_image/2026-08-16/vor-line-of-sight-ALB.png" %}
...
{% include image_caption_href.html title="Route Comparison - CPL Checkride" caption="Route Comparison - CPL Checkride" imageurl="/posts_image/2026-08-16/route-compare-CPL-checkride.png" %}
...
{% include image_caption_href.html title="Direct Route Comparison (ForeFlight)" caption="Direct Route Comparison (ForeFlight)" imageurl="/posts_image/2026-08-16/route-compare-direct.png" %}

**Not-Direct route: 185NM / 15gal / 2hr 00min**
{% include image_caption_href.html title="Pilotage Route Comparison (ForeFlight)" caption="Pilotage Route Comparison (ForeFlight)" imageurl="/posts_image/2026-08-16/route-compare-pilotage.png" %}
